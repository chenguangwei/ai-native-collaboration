...
```json
// 前端工程师
{ "currentRole": "frontend", "gitUser": "fe@company.com" }

// 后端工程师
{ "currentRole": "backend", "gitUser": "be@company.com" }

// 全栈工程师
{ "currentRole": "fullstack", "gitUser": "fs@company.com" }
```
...
| [SKILLS_INDEX.md](../06_skills/SKILLS_INDEX.md) | 80 个技能完整索引 |
