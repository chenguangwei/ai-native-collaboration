...
3. [产品工程师](#产品工程师) — 端到端交付产品特性
4. [AI 工程师](#ai-工程师) — Agent 编排、LLM 集成、AI 流水线
5. [质量工程师](#质量工程师) — 全栈测试 + 安全 + 可靠性
6. [平台工程师](#平台工程师) — 基础设施、CI/CD、开发者体验
...
> **角色定位**：端到端交付产品特性。不区分前端/后端/语言栈——AI 处理技术细节，你负责产品判断和用户价值交付。
...
> **角色定位**：让团队高效开发的基础设施保障者。包括 CI/CD、可观测性、成本优化、开发者体验。
...
| 技能 | 触发 | 来源 | 用途 |
|------|------|------|------|
| `systematic-debugging` | `/systematic-debugging` | 🔧 | 结构化故障排查 |
| `gstack-investigate` | `/investigate` | 🌐 | 问题根因调查 |
| `gstack-retro` | `/retro` | 🌐 | 故障复盘 |
