...
| 角色 | 描述 | Memory 目录 |
|------|------|-------------|
| product-engineer | 产品工程师（替代 frontend/backend/fullstack）| `memory/roles/product-engineer/` |
| ai-engineer | AI 工程师（Agent 编排、LLM 集成）| `memory/roles/ai-engineer/` |
| quality-engineer | 质量工程师（全栈测试+安全+可靠性）| `memory/roles/quality-engineer/` |
| platform-engineer | 平台工程师（基础设施、CI/CD）| `memory/roles/platform-engineer/` |
